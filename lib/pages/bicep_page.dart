...
class BicepPage extends StatefulWidget {
  ...
  @override
  State<BicepPage> createState() => _BicepPageState();
}
...
class _BicepPageState extends State<BicepPage> {
  ...
  getChat() {
    DatabaseService().getChat("MTTslv3Ylt2sYxKEMxns").then((val) {
      setState(() {
        chats = val;
      });
    });
  ...
  sendMessage() {
    if (messageController.text.isNotEmpty) {
      ...
      DatabaseService().sendMessage("MTTslv3Ylt2sYxKEMxns", chatMessageMap);
      setState(() {
