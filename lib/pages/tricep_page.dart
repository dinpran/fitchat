...
class TricepPage extends StatefulWidget {
  const TricepPage({super.key});

  @override
  State<TricepPage> createState() => _TricepPageState();
}

class _TricepPageState extends State<TricepPage> {
  ...
  getChat() {
    DatabaseService().getChat("GJme17BOfhTi3Gg7ZiL6").then((val) {
      setState(() {
        chats = val;
      });
    });
  ...
  sendMessage() {
    if (messageController.text.isNotEmpty) {
      ...
      DatabaseService().sendMessage("GJme17BOfhTi3Gg7ZiL6", chatMessageMap);
      setState(() {
